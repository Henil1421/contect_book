...
class _updatepageState extends State<updatepage> {
  ...
  void pickimageopen(imagetype) async {
    final photo = await ImagePicker().getImage(source: imagetype);
    if (photo == null) {
      return;
    }
                ...
                children: [
                  ...
                  Stack(
                    ...
                    children: [
                      CircleAvatar(
                        radius: 50,
                        backgroundImage: (pickimages == null)
                            ? (m.img == null)
                                ? (themecolorbool)
                                    ? const AssetImage("images/profile.png")
                                    : const AssetImage("images/darkprofile.png")
                                : FileImage(m.img) as ImageProvider
                            : FileImage(pickimages!),
